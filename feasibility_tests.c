...
/**********************************************************Tests_included from examples*******************************************************/
// U=1.06
U32_T ex5_period[] = {2, 4, 16};						//array for periods
U32_T ex5_wcet[] = {1, 1, 5};							//array for wcet

// U=1.0
U32_T ex6_period[] = {2, 5, 10};						//array for periods
U32_T ex6_wcet[] = {1, 2, 1};							//array for wcet

// U=1.0
U32_T ex7_period[] = {3, 5, 15};						//array for periods
U32_T ex7_wcet[] = {1, 2, 4};							//array for wcet

// U=1.0
U32_T ex8_period[] = {6, 8, 12, 24};						//array for periods
U32_T ex8_wcet[] = {1, 2, 4, 6};						//array for wcet

// U=0.9847
U32_T ex9_period[] = {2, 5, 7, 14};						//array for periods
U32_T ex9_wcet[] = {1, 1, 1, 2};						//array for wcet

// U=1.0
U32_T ex10_period[] = {3, 6, 9};						//array for periods
U32_T ex10_wcet[] = {1, 2, 3};							//array for wcet

// U=1.0
U32_T ex11_period[] = {2, 4, 8};						//array for periods
U32_T ex11_wcet[] = {1, 1, 2};							//array for wcet
...
/**********************************************************Tests_included from examples*******************************************************/
    ...
    printf("Ex-5 U=%4.2f\% (C1=1, C2=1, C3=5; T1=2, T2=4, T3=16; T=D): ",
    ...
    printf("Ex-8 U=%4.2f\% (C1=1, C2=2, C3=4, C4=6; T1=6, T2=8, T3=12, T4=24; T=D): ",
    ...
    printf("Ex-9 U=%4.2f\% (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7, T4=14; T=D): ",
    ...
    printf("Ex-10 U=%4.2f\% (C1=1, C2=2, C3=3; T1=3, T2=6, T3=9; T=D): ",
    ...
    printf("Ex-11 U=%4.2f\% (C1=1, C2=1, C3=2; T1=2, T2=4, T3=8; T=D): ",
		   ((1.0/2.0)*100.0 + (1.0/4.0)*100.0 + (2.0/8.0)*100.0));
	numServices = 3;
    if(completion_time_feasibility(numServices, ex11_period, ex11_wcet, ex11_period) == TRUE)
        printf("FEASIBLE\n");
    else
        printf("INFEASIBLE\n");

    if(rate_monotonic_least_upper_bound(numServices, ex11_period, ex11_wcet, ex11_period) == TRUE)
        printf("RM LUB FEASIBLE\n");
    else
        printf("RM LUB INFEASIBLE\n");
    printf("\n");
...
/**********************************************************Tests_included from examples*******************************************************/
    ...
    printf("Ex-11 U=%4.2f\% (C1=1, C2=1, C3=2; T1=2, T2=4, T3=8; T=D): ",
		   ((1.0/2.0)*100.0 + (1.0/4.0)*100.0 + (2.0/8.0)*100.0));
	numServices = 3;
    if(scheduling_point_feasibility(numServices, ex11_period, ex11_wcet, ex11_period) == TRUE)
        printf("FEASIBLE\n");
    else
        printf("INFEASIBLE\n");
